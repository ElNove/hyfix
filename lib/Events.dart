          ...
          child: Container(
            ...
            decoration: i.tipo == "A"
                ? BoxDecoration(
                    ...
                    color: i.attivita == 'TRASFERTA'
                        ? Theme.of(context)
                            .colorScheme
                            .errorContainer //COLOR FROM REQUEST
                        : i.attivita == 'WORK'
                            ? Theme.of(context)
                                .colorScheme
                                .tertiary //COLOR FROM REQUEST
                            : Theme.of(context)
                                .colorScheme
                                .inversePrimary, //COLOR FROM REQUEST
                  )
                : DiagonalDecoration(
                    radius: Radius.circular(8),
                    lineColor: i.attivita == 'TRASFERTA'
                        ? Colors.red
                        : i.attivita == 'WORK'
                            ? Colors.green
                            : Colors.blue,
                    lineWidth: 9,
                    backgroundColor: i.attivita == 'TRASFERTA'
                        ? const Color.fromARGB(255, 255, 95, 83)
                        : i.attivita == 'WORK'
                            ? const Color.fromARGB(255, 113, 255, 118)
                            : const Color.fromARGB(255, 94, 182, 255),
